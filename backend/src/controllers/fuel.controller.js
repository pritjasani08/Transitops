...
const repo = new BaseRepository('fuels');

exports.create = async (req, res, next) => {
  try {
    const data = await repo.create(req.body);
    res.json({ success: true, message: 'Fuel created successfully', data });
...
exports.update = async (req, res, next) => {
  try {
    ...
    res.json({ success: true, message: 'Fuel updated successfully', data });
  } catch (error) { next(error); }
};
...
exports.delete = async (req, res, next) => {
  try {
    ...
    res.json({ success: true, message: 'Fuel deleted successfully', data: {} });
  } catch (error) { next(error); }
};
