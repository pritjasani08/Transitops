    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-text-muted mt-1">Track and approve all fleet-related operational expenses.</p>
        </div>
          ...
          <div className="overflow-x-auto">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {filteredExpenses.map(expense => (
                  <tr key={expense.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-900/50 transition-colors">
                    <td className="px-6 py-4 font-medium text-text-primary">{expense.id}</td>
                    ...
                    <td className="px-6 py-4 font-semibold text-text-primary">{formatCurrency(expense.amount)}</td>
                    <td className="px-6 py-4">
            ...
            {filteredExpenses.length === 0 && (
              <div className="text-center py-12">
                <p className="text-text-muted">No expenses found matching your search.</p>
              </div>
            )}
          </div>
        </CardContent>
